...
class CaseOnDisk(SumoCase):
    ...
    #        file sto upload should instead be picked up through the "manifest" from fmu-dataio
    # TODO: remove this function and other related code when we fully remove support for search_string
